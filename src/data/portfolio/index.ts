...
export const portfolioData: portfolio[] = [
  ...
  },
  {
    ...
    descriptions: [{ content: "공공데이터포털 API ( https://www.data.go.kr/ ) 를 이용한 Side Project" }, { content: "경찰청 범죄 발생 지역별 통계 , 경찰청_전국 경찰서별 강력범죄 발생현황 API 수신" }, { content: "Chart.js / Next.js 를 이용하여 대시보드 및 데이터 현황 웹 어플리케이션 제작" }],
    link: "https://github.com/dahun428-fx/next_canvas",
    link2: "https://next-canvas-pied.vercel.app/",
    skillKeywords: ["React.js", "Next.js", "RESTFul Api", "공공데이터포털 API", "Redux", "Chart.js", "Typescript"],
  },
];
